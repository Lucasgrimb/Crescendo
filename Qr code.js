...
function displaySongs(songs) {
  ...
  if (songs.length === 0) {
    ...
    songs.forEach((song) => {
      ...
      // Aquí se decide dónde se añadirá el songItem basado en su estado
      if (song.state === 'accepted') {
        ...
        acceptButton.remove(); // Suponiendo que no quieres mostrar los botones si ya está aceptada
        rejectButton.remove(); // Suponiendo que no quieres mostrar los botones si ya está aceptada
        ...
        acceptButton.remove(); // Suponiendo que no quieres mostrar los botones si ya está rechazada
        rejectButton.remove(); // Suponiendo que no quieres mostrar los botones si ya está rechazada
      } else {

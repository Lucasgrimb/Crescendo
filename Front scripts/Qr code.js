...
function ajustarPosiciones() {
  ...
  if (peticionesHeight === 0) {
    ...
    acceptPeticion.style.top = `${peticionesHeight + alturaAdicional * 1.1}px`;
    rejectPeticion.style.top = `${peticionesHeight + alturaAdicional * 3.1 + espacioEntreSecciones}px`;
  }
}
